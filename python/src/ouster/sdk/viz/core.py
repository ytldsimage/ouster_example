...
class LidarFrameViz:
    ...
    def cycle_panel_view_mode(self) -> None:
        ...
        with self._lock:
            ...
            # Reposition panels based on new view mode
    ...
    def _setup_controls(self) -> None:
        ...
        key_bindings: Dict[Tuple[int, int], Callable[[LidarFrameViz], None]] = {
            ...
            (ord('R'), 0): partial(LidarFrameViz.cycle_img_mode, i=10, direction=+1),
            (ord('T'), 0): partial(LidarFrameViz.cycle_img_mode, i=10, direction=-1),
            ...
            (ord('T'), 0): LidarFrameViz.cycle_panel_view_mode,
        }
        ...
        self._key_definitions: Dict[str, str] = {
            ...
            "r / SHIFT+r": "Cycle image panel 10 (MIX_CALREF)",
            "t": "Toggle panel view: ALL → FIRST 5 → LAST 5",
